        ...
        <div className="flex flex-col justify-between flex-1 gap-2">
          <div className="flex flex-row justify-between">
            ...
            <div className="flex flex-row gap-2">
              <div className="text-sm">({index + 1}/{TESTIMONIALS.length})</div>
              <div className="flex justify-center items-center rounded-full h-6 w-6 bg-gray-200 hover:cursor-pointer" onClick={() => handleOnClickBack()}>
                <ChevronLeftIcon strokeWidth={1} className="h-4 w-4" />
              </div>
              <div className="flex justify-center items-center rounded-full h-6 w-6 bg-gray-200 hover:cursor-pointer" onClick={() => handleOnClickNext()}>
