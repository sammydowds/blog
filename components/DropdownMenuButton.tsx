...
const items = [
  { name: 'Resume', description: 'Download a copy of my resume.', href: '#', icon: DocumentArrowDownIcon},
  { name: 'LinkedIn', description: 'View my references, work history, and experiences.', href: '#', icon: BriefcaseIcon},
  { name: 'GitHub', description: 'View my code.', href: '#', icon: CodeBracketSquareIcon},
]
